  ...
  return (
   <div className="flex w-full h-screen ">
        ...
        >
          ...
          <div className="mt-7">
            ...
            <div className="flex mt-5 gap-4">
                <div className="flex">
                    <p>Ya tienes cuenta?</p><button className="font-medium text-base text-cyan-500 cursor-pointer"> sing in</button>
                </div>  
            </div>
      ...
      <div className="hidden relative lg:flex h h-full w-1/2 items-center justify-center bg-gray-200">
          <div className="w-60 h-60 bg-gradient-to-tr from-amber-500 to-cyan-500 rounded-full animate-spin"/>
