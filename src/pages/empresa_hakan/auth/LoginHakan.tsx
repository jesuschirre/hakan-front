            ...
            >
              ...
              <div className="mt-7">
                ...
                <div className="flex mt-5 gap-4">
                    <button className=" font-medium text-base text-violet-500 cursor-pointer">Recuperar tu contraseña</button>
                </div>
                ...
                <div className="mt-6 flex flex-col gap-y-4">
                    ...
                    className="active:scale-[.98] active:duration-75 transition-all font-bold  w-full 
                            bg-violet-500 rounded-xl text-white text-lg py-3 hover:scale-[1.01] ease-in-out cursor-pointer"
                    >
                        Sign in
                    </button>
                </div>
